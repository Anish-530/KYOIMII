...
module.exports={
    ...
    aliases: ['swc', 'setwc'],
    usage: 'k!setwelcome <mention a channel>',
    run: async(bot, message, args)=>{
        ...
        if(!channel){
            ...
            \`\`\`fix
k!setwelcome <mention a channel>\`\`\``)
            ...
            .setDescription(`<:good:776121655528783964> Welcome channel for **${message.guild.name}**, is now set as ${channel}`)
            .setColor('#2f3136')
